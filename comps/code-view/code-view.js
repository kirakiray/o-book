...
Component(async ({ load }) => {
    if (!window.hljs) {
        ...
        await load("./hljs/highlight.min.js");
    }
    ...
    @font-face {
        ...
        src: url('//at.alicdn.com/t/font_2748481_gvifasjqbfo.woff2?t=1629274718408') format('woff2'),
             url('//at.alicdn.com/t/font_2748481_gvifasjqbfo.woff?t=1629274718408') format('woff'),
             url('//at.alicdn.com/t/font_2748481_gvifasjqbfo.ttf?t=1629274718408') format('truetype');
    }
    </style>`)
